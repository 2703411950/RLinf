...
export RLINF_COMM_NET_DEVICES="wlx6c1ff7b774a9" # Change this if you use a different network interface

# If you are using the docker image, change this to source switch_env franka-<version>, e.g., switch_env franka-0.15.0
source /home/cyy/RLinf/.venv/bin/activate # Source your virtual environment here
